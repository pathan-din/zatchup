...
@Component({
  selector: 'app-add-past-ei',
  templateUrl: './add-past-ei.component.html',
  styleUrls: ['./add-past-ei.component.css']
})
export class AddPastEiComponent implements OnInit {
  model:any={};
  modelZatchup:any={};
  stateList:any=[];
  cityList:any=[];
