...
export class UserSignUpComponent implements OnInit {
  ...
  yearModel:any;
  /*********************************************************/
 constructor(private genericFormValidationService:GenericFormValidationService,private router: Router,private SpinnerService: NgxSpinnerService,public userService:UsersServiceService,public formBuilder: FormBuilder) { }
