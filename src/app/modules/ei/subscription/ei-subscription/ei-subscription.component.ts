...
export class EiSubscriptionComponent implements OnInit {
  ...
  makePayment() {
    this.paymentHtml = '';
    this.paymentHtml += '<div class="row"><div class="col-md-7 pr-0">Price:</div> <div class="col-md-5 pr-0 text-left color-purple">&#8377; ' + this.subscription.current_amount + '</div></div>';
