...
@Component({
  selector: 'app-ei-eresult-preview',
  templateUrl: './ei-eresult-preview.component.html',
  styleUrls: ['./ei-eresult-preview.component.css']
})
export class EiEresultPreviewComponent implements OnInit {
