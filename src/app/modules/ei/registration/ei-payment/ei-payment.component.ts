...
export class EiPaymentComponent implements OnInit {
  ...
  error:any
  paymentHtml:any;
  constructor(private router: Router,private genericFormValidationService:GenericFormValidationService,private SpinnerService: NgxSpinnerService,public eiService:EiServiceService,public formBuilder: FormBuilder) { }
